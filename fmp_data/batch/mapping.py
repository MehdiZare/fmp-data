...
SHORT_HINT = ParameterHint(
    natural_names=["short", "brief", "condensed", "compact"],
    extraction_patterns=[
        r"(?i)\b(short|brief|compact|condensed|lightweight)\b",
    ],
    examples=["true", "false"],
    context_clues=["short", "brief", "condensed", "price only", "just the price"],
)

PART_HINT = ParameterHint(
    natural_names=["part", "chunk", "file part", "bulk segment"],
    extraction_patterns=[
        r"(?i)part\s*(\d+)",
        r"(?i)chunk\s*(\d+)",
    ],
    examples=["0", "1", "2"],
    context_clues=["part", "chunk", "segment", "bulk file", "split", "piece"],
)
...
BATCH_ENDPOINTS_SEMANTICS = {
    "batch_quote": EndpointSemantics(
        ...
        parameter_hints={"symbols": SYMBOLS_HINT},
        response_hints={},
        use_cases=[
    ...
    "exchange_quotes": EndpointSemantics(
        ...
        category=SemanticCategory.MARKET_DATA,
        parameter_hints={"exchange": EXCHANGE_HINT, "short": SHORT_HINT},
        response_hints={},
        use_cases=["Market data analysis", "Financial research"],
    ),
    "mutualfund_quotes": EndpointSemantics(
        ...
        category=SemanticCategory.MARKET_DATA,
        parameter_hints={"short": SHORT_HINT},
        response_hints={},
        use_cases=["Market data analysis", "Financial research"],
    ),
    ...
    "profile_bulk": EndpointSemantics(
        ...
        parameter_hints={"part": PART_HINT},
        response_hints={},
        use_cases=["Market data analysis", "Financial research"],
    ),
    ...
    "earnings_surprises_bulk": EndpointSemantics(
        ...
        category=SemanticCategory.FUNDAMENTAL_ANALYSIS,
        parameter_hints={"year": YEAR_HINT},
        response_hints={},
        use_cases=["Market data analysis", "Financial research"],
    ),
    "income_statement_bulk": EndpointSemantics(
        ...
        category=SemanticCategory.FUNDAMENTAL_ANALYSIS,
        parameter_hints={"year": YEAR_HINT, "period": FISCAL_PERIOD_HINT},
        response_hints={},
        use_cases=["Market data analysis", "Financial research"],
    ),
