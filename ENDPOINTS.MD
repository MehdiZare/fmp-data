...
- Historical Price (Daily) `/stable/historical-price-eod`
...
- Historical Price `/v3/historical-price-eod/{cryptoPair}`
...
- Historical Price `/v3/historical-price-eod/{forexPair}`
...
- Historical Price `/v3/historical-price-eod/{commodity}`
